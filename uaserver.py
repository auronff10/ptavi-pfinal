    ...
    def handle(self): # Recibimos del cliente y dependiendo del metodo actuamos
        while 1:
            ...
            metodo != "BYE" and metodo: # Comprobamos primero el metodo.
                ...
                Log1.write(" Received from ") # Extraemos IP y Puerto del proxy.
                ...
                if len(Message) == 9: # EL Description siempre tiene los mismos elementos
                    ...
                    Log1.write(" SIP/2.0 100 Trying") # La misma info en el log.
                    ...
                    Lista = [Ip1, Puerto1]
                    Description[Usuario1] = Lista # Pasan al diccionario los datos
                ...
                for User in Description:
                    Log1 = etiquetas[4]
                    Log1 = Log1["path"]
                    Log1 = open(Log1, "a") #ABrimos el log y vamos appendiendo
                    Lista = Description[User] # Para transmicion RTP puerto e IP
                    Cancion = etiquetas[5]
